...
// Access the route parameters to get the lessonId
const route = useRoute();
const lessonId = route.params.id; // assuming the lessonId is in the route params
...
const submitForm = async () => {
  ...
  // Include lessonId in the quiz data
  const quizData = {
    lessonId, // Add lessonId from route params
